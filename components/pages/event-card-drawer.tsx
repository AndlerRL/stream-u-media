...
export function EventCardDrawer({ eventData }: { eventData: { name: string, description: string } }) {
    ...
    <Drawer>
      ...
      <DrawerContent>
        <div className="mx-auto w-full max-w-sm py-8">
          <DrawerHeader>
            <DrawerTitle>{eventData.name}</DrawerTitle>
            <DrawerDescription>{eventData.description}</DrawerDescription>
          </DrawerHeader>
